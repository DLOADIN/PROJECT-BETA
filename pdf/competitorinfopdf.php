<?php
  ...
  $pageWidth = 700; // Example: A4 width is 210mm
  ...
  $customHeaderNames = array(
    'id' => '#',
    'u_companyname' => 'COMPANY NAME',
    'u_marketvalue' => 'MARKET VALUE',
    'u_marketprice' => 'MARKET PRICE',
    'u_streetaddress' => 'STREET ADDRESS',
    'u_city' => 'CURRENT CITY',
    'u_province' => 'PROVINCE',
    'u_district' => 'DISTRICT',
    'u_cell' => 'CELL',
